...
import com.kynsof.identity.application.query.business.getwithimages.BusinessWithImagesResponse;
import com.kynsof.identity.application.query.business.getwithimages.FindBusinessWithImagesQuery;
...
public class BusinessController {
    ...
    @GetMapping(path = "/{id}/with-images")
    public ResponseEntity<?> getByIdWithImages(@PathVariable UUID id) {

        FindBusinessWithImagesQuery query = new FindBusinessWithImagesQuery(id);
        BusinessWithImagesResponse response = mediator.send(query);
